        ...
        <div class="col-12 p-4">
            ...
            <div class="row">
                ...
                <div class="col text-end">
                    <a href="?ct=main&mt=index" class="btn btn-secondary px-4"><i class="bi bi-chevron-left me-2"></i>Voltar</a>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-6 col-12 p-1">
                    <div class="card p-3">
                        <h4><i class="bi bi-people-fill me-2"></i>Clientes dos agentes</h4>
                ...
                <div class="col-sm-6 col-12 p-1">
                    <div class="card p-3">
                        <h4><i class="bi bi-people-fill me-2"></i>Gráfico</h4>
            ...
            <div class="row mb-3">
                <div class="col p-1">
                    ...
                    <div class="card p-3">
                        <h4><i class="bi bi-list-ul me-2"></i>Dados estatísticos globais</h4>
                        ...
                        <div class="text-center">
                            <a href="?ct=admin&mt=create_pdf_report" target="_blank" class="btn btn-secondary px-4"><i class="bi bi-filetype-pdf me-2"></i>Criar relatório em PDF</a>
                        </div>
